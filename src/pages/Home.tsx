...
const services = [
  {
    ...
    desc: "Clean cuts tailored to your face shape and style.",
    price: "₦3,500",
  },
  {
    title: "Beard Sculpting",
    desc: "Sharp lines, defined edges, perfectly shaped beard.",
    price: "₦2,500",
  },
  {
...
export default function Home() {
  return (
    <main className="page-enter">
      <SEO
        title="Premium Barbershop in Lagos"
        description="Danny Salon — Lagos' finest barbershop. Expert haircuts, beard sculpting and hot towel shaves in Victoria Island. Book your appointment today."
        canonical="/"
      />
      {/* ── HERO ── */}
      <section
        ...
        >
          <div style={{ maxWidth: "780px" }}>
            ...
            >
              The Art
              <br />
              of the <span className="gold-text">Perfect</span>
              <br />
              Cut
            </h1>
            ...
            >
              Premium grooming for the modern gentleman. Where every visit is an
      ...
      <section style={{ padding: "7rem 2rem" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Founded in Lagos with a single belief — that every man deserves to
              look and feel his absolute best. Blade & Co. is where craft meets
              culture.
            </p>
            <p
              style={{
            ...
            >
              Our master barbers bring years of training and passion to every
              chair. From classic fades to precise beard sculpting, we deliver
      ...
      {/* ── SERVICES TEASER ── */}
      <section
        style={{ padding: "5rem 2rem 7rem", background: "var(--surface)" }}
      >
