  ...
  return (
    <main className="page-enter">
      <SEO
        ...
        description="Reserve your seat at Danny Salon. Book a haircut, beard sculpt or premium grooming session online. Walk-ins welcome, appointments get priority."
        canonical="/book"
      />
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              <textarea
                ...
                onChange={handleChange}
                style={inputStyle}
                placeholder="e.g., preferred style, allergies, etc."
              />
            </div>
          </div>
          ...
          >
            We'll send a confirmation within 2 hours. Walk-ins welcome but
        ...
        <div style={{ marginTop: "3rem", textAlign: "center" }}>
          <p style={{ color: "var(--text-muted)" }}>
            📞 Prefer to call?{" "}
            <span className="gold-text">+234 812 345 6789</span>
          </p>
        </div>
      </section>
    </main>
