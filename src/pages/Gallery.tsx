...
const images = [
  {
    src: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=800&auto=format&fit=crop",
    label: "Fade & Taper",
    span: 2,
  },
  {
    src: "https://images.unsplash.com/photo-1599351431202-1e0f0137899a?w=800&auto=format&fit=crop",
    label: "Classic Cut",
    span: 1,
  },
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1534297635766-a262cdcb8ee4?w=800&auto=format&fit=crop",
    label: "Beard Sculpt",
    span: 1,
  },
  {
    src: "https://images.unsplash.com/photo-1521119989659-a83eee488004?w=800&auto=format&fit=crop",
    label: "Styling",
    span: 1,
  },
  {
    src: "https://images.unsplash.com/photo-1580618672591-eb180b1a973f?w=800&auto=format&fit=crop",
...
export default function Gallery() {
  return (
    <main className="page-enter">
      <SEO
        title="Gallery"
        description="See our work — precision fades, beard sculpts, classic cuts and more. Browse the Danny Salon gallery and get inspired for your next visit."
        canonical="/gallery"
      />
      {/* ── PAGE HERO ── */}
      <section
      ...
      >
        ...
        >
          ...
          >
            Every cut tells a story. Here's a glimpse of what walks out of our
            chairs.
          </p>
          <div
            className="gold-line"
