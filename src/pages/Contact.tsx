...
export default function Contact() {
  ...
  return (
    <main className="page-enter">
      <SEO
        title="Contact Us"
        description="Get in touch with Danny Salon. Find us on 12 Broad Street, Victoria Island, Lagos. Call, email or drop us a message — we'd love to hear from you."
        canonical="/contact"
      />
      <section
        style={{
          ...
          <div>
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={{ color: "var(--text-muted)" }}>
                47 Admiralty Way, Lekki Phase 1<br />
                Lagos, Nigeria
              </p>
            </div>
